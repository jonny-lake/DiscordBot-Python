...
def machineLearnMeanWords():
    insult = (str("Thou " + column1[int(random.random()*np.size(column1))]+ " " + column2[int(random.random()*np.size(column2))] + " " + column3[int(random.random()*np.size(column3))] + "!"))
    return insult